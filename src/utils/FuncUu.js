...
export function rash_co(qco, t1, t2, p1, p2) {
...
export function rash_gvs(
  ...
  let tt4 = "";
  d_dep > 0
    ? ((tt3 = t1_), (tt4 = 55), (txvL = t2), (txvZ = t2))
    : ((tt3 = t1), (tt4 = t2));
  d_dep == 2 ? (koef = 0.55) : "";

  let G3m = +((koef * qm * 1000) / (t1 - txvZ)).toFixed(3); //*

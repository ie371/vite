<template>
  ...
  >
    ...
    <div class="text-xs px-1 xl:col-span-2 md:col-span-3">
      <Ot :project="project" @no_co="no_co" />
    </div>
...
import Atm from "../components/uuts/Atm.vue";
import Ot from "../components/uuts/Ot.vue";
...
export default {
  ...
  setup() {
    ...
    if (!project_store.value.OBJ_TS) {
      ...
      project_store.value.OBJ_TS = add_class.value;
    }
    const project = ref(project_store.value.OBJ_TS);

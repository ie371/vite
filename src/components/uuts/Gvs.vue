    ...
    <transition name="bounce">
      ...
      <div v-if="!hide">
        ...
        <div class="flex w-full justify-start mt-1 items-center">
          ...
          <div v-if="!tup" class="w-1/2 px-1 text-center">
            <label class="pl-0">Обр.клапан</label>
            <input
              :disabled="no_ok"
              type="checkbox"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    watch(
      ...
      () => {
        !itp.value
          ? ((T3.value = "T3"), (T4.value = "T4"))
          : ((T3.value = "T12"), (T4.value = "T22"));
      }
    );

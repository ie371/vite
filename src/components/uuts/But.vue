    ...
    <div>
      <div class="px-1 truncate">
        ...
        <transition name="bounce">
          <div class="w-full px-2 mt-1" v-show="pr1">
          ...
          <div class="flex w-full items-end">
            <div class="w-11/12">
              ...
              <input
                class="w-full"
                type="text"
                v-model.number="project.atm.listn.mont_ot"
              />
            </div>
            ...
            <div class="w-1/12 pl-1 text-center">
              <button
                ...
                class="focus:outline-none text-xs hover:text-blue-600"
                :class="
                  project.atm.prim.mont_ot || file3
        ...
        <transition name="bounce">
          <div class="w-full px-2 mt-1" v-show="pr3">
            <div class="flex w-full items-end">
              <div class="w-8/12">
                <file-input v-model="file3" name="mont_ot_uploads" isImage />
              </div>
              <div class="w-1/12 pl-1 text-center">
                <label class="pl-0">A2</label>
                <input
                  type="checkbox"
                  v-model.number="project.atm.format.mont_ot"
                  :disabled="dis3"
                  class="h-4 w-4 m-auto"
                />
              </div>
              <div class="w-2/12 pl-1 text-center">
                ...
                <input
                  type="checkbox"
                  v-model.number="project.atm.add.mont_ot"
                  :disabled="dis3"
                  class="h-4 w-4 m-auto"
                />
              </div>
            ...
            <textarea
              class="w-full mt-2 border border-gray-300 focus:outline-none p-2 overflow-y h-20 text-xss font-bold"
              v-model="project.atm.prim.mont_ot"
              rows="10"
            ></textarea>
          </div>
        </transition>
          ...
          <div class="flex w-full items-end">
            <div class="w-11/12">
              ...
              <input
                class="w-full"
                type="text"
                v-model.number="project.atm.listn.mont_gvs"
              />
            </div>
            ...
            <div class="w-1/12 pl-1 text-center">
              <button
                ...
                class="focus:outline-none text-xs hover:text-blue-600"
                :class="
                  project.atm.prim.mont_gvs || file4
                    ? 'text-red-600 font-bold'
                    : ''
                "
              >
        ...
        <transition name="bounce">
          <div class="w-full px-2 mt-2" v-show="pr4">
            <div class="flex w-full items-end">
              <div class="w-8/12">
                <file-input v-model="file4" name="mont_gvs_uploads" isImage />
              </div>
              <div class="w-1/12 pl-1 text-center">
                <label class="pl-0">A2</label>
                <input
                  type="checkbox"
                  v-model.number="project.atm.format.mont_gvs"
                  :disabled="dis4"
                  class="h-4 w-4 m-auto"
                />
              </div>
              <div class="w-2/12 pl-1 text-center">
                ...
                <input
                  type="checkbox"
                  v-model.number="project.atm.add.mont_gvs"
                  :disabled="dis4"
                  class="h-4 w-4 m-auto"
                />
              </div>
            ...
            <textarea
              class="w-full mt-2 border border-gray-300 focus:outline-none p-2 overflow-y h-20 text-xss font-bold"
              v-model="project.atm.prim.mont_gvs"
              rows="10"
            ></textarea>
          </div>
        </transition>
        ...
        <transition name="bounce">
          <div class="w-full px-2 mt-2" v-show="pr5">
            <div class="flex w-full items-end">
              <div class="w-8/12">
                <file-input v-model="file5" name="func_uploads" isImage />
              </div>
              <div class="w-1/12 pl-1 text-center">
                <label class="pl-0">A2</label>
                <input
          ...
          <div class="flex w-full items-end">
            ...
            <div class="w-1/12 pl-1 text-center">
              <button
                ...
                class="focus:outline-none text-xs hover:text-blue-600"
                :class="
                  project.atm.prim.spec || file6 ? 'text-red-600 font-bold' : ''
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <transition name="bounce">
          <div class="w-full px-2 mt-1" v-show="pr6">
            <div class="w-2/3">
              <file-input v-model="file6" name="spec_uploads" isPdf />
            </div>
            <textarea
  ...
  setup(props) {
    ...
    watch(file3, () => {
      file3.value ? (dis3.value = false) : (dis3.value = true),
        (project.value.atm.format.mont_ot = false),
        (project.value.atm.add.mont_ot = false);
    });
    watch(file4, () => {
      file4.value ? (dis4.value = false) : (dis4.value = true),
        (project.value.atm.format.mont_gvs = false),
        (project.value.atm.add.mont_gvs = false);
    });
    watch(file5, () => {
      file5.value ? (dis5.value = false) : (dis5.value = true),
